...
|---------|--------|--------------|------|
| DFT-0001 | Planning | This task — establishes the authenticated connection. | `work/02-planning/DFT-0001-set-up-salesforce-connected-app-and-oauth/task.md` |
| DFT-0002 | Planning | Depends on DFT-0001 — needs the permission-filtered data access layer. | `work/02-planning/DFT-0002.md` |
| DFT-0003 | Planning | Needs the authenticated API gateway. | `work/02-planning/DFT-0003.md` |
| DFT-0010 | Planning | Uses the same permission/approval model for pricing guardrails. | `work/02-planning/DFT-0010.md` |

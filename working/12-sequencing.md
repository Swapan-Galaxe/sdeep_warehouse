...
- [ ] Document the setup steps for DFT-0002 and DFT-0003 consumers.

## Parallel Work Opportunities

- The API gateway OAuth callback endpoint (`DFT-0003`) can be designed in parallel, using the helper interface defined in this task.
- The agent orchestrator (`DFT-0005`) and lead/opportunity insights (`DFT-0006/0007`) can continue design work while this task is being implemented, because the data access contract is known.

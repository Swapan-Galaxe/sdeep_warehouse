# Goals and Constraints: SDE-0001
...
- [ ] **No data ingestion or scoring**: This task is limited to authentication and connection setup; lead scoring and insight generation are handled by SDE-0002+.
